// lib/features/auth/presentation/screens/improved_otp_verification_screen.dart
import 'dart:async';
...
import '../../../../core/presentation/providers/improved_auth_provider.dart';
...
class ImprovedOTPVerificationScreen extends ConsumerStatefulWidget {
  const ImprovedOTPVerificationScreen({
    super.key,
  ...
  @override
  ConsumerState<ImprovedOTPVerificationScreen> createState() =>
      _ImprovedOTPVerificationScreenState();
}

class _ImprovedOTPVerificationScreenState extends ConsumerState<ImprovedOTPVerificationScreen>
  ...
  void _listenToAuthState() {
    ref.listen<AuthState>(improvedAuthProvider, (previous, next) {
      if (!mounted) return;
