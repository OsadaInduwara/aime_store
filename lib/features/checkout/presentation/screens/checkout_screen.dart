...
import '../../../../core/presentation/providers/address_provider.dart';
import '../../../../core/presentation/providers/cart_provider.dart';
import '../../../../core/presentation/providers/checkout_provider.dart';
...
class _CheckoutScreenState extends ConsumerState<CheckoutScreen> {
        ...
        data: (cartItems) {
          ...
          return Column(
            children: [
              ...
              _buildCheckoutBottomSheet(context, ref, checkoutState),
            ],
          );
        },
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      CurrencyFormatter.formatLegacy(item.totalPrice),
                      style: theme.textTheme.bodyMedium?.copyWith(
                        fontWeight: FontWeight.w600,
                      ),
                    ),
                    if (item.quantity > 1) ...[
                      SizedBox(height: 2.h),
                      Text(
                        '${CurrencyFormatter.formatLegacy(item.unitPrice)} each',
                        style: theme.textTheme.bodySmall?.copyWith(
                          color: theme.textTheme.bodySmall?.color,
                        ),
                      ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text(
                deliveryFee == 0 ? 'Free' : CurrencyFormatter.formatLegacy(deliveryFee),
                style: theme.textTheme.bodyLarge?.copyWith(
                  fontWeight: FontWeight.w600,
  ...
  Widget _buildCheckoutBottomSheet(BuildContext context, WidgetRef ref, AsyncValue<bool> checkoutState) {
    final theme = Theme.of(context);
