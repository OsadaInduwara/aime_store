    ...
    return Scaffold(
      body: CustomScrollView(
        ...
        slivers: [
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      // TODO: Implement stores listing page
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Stores page coming soon!')),
                      );
                    },
                    child: Text(l10n.seeAll),
                  ),
          ...
          const SliverToBoxAdapter(
            child: PersonalizedRecommendationSection(),
          ),
          ...
          // Trending Products
          const SliverToBoxAdapter(
            child: TrendingRecommendationSection(),
          ),
