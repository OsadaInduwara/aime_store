// lib/core/presentation/providers/improved_auth_provider.dart
import 'dart:async';
...
final improvedAuthProvider = StateNotifierProvider<ImprovedAuthNotifier, AuthState>(
  (ref) => ImprovedAuthNotifier(),
);

/// Authentication controller provider for UI actions
final authControllerProvider = Provider<AuthController>(
  (ref) => AuthController(ref.read(improvedAuthProvider.notifier)),
);

class ImprovedAuthNotifier extends StateNotifier<AuthState> {
  ImprovedAuthNotifier() : super(const AuthState.authenticating()) {
    _init();
  }
...
class AuthController {
  ...
  final ImprovedAuthNotifier _notifier;
